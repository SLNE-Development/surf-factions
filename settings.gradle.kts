...
// User
include("surf-factions-user:surf-factions-user-api")
include("surf-factions-user:surf-factions-user-core:surf-factions-user-core-common")
include("surf-factions-user:surf-factions-user-core:surf-factions-user-core-client")
include("surf-factions-user:surf-factions-user-microservice")
include("surf-factions-user:surf-factions-user-client:surf-factions-user-client-paper")
include("surf-factions-user:surf-factions-user-client:surf-factions-user-client-velocity")